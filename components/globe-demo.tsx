...
const destinations = [
    {
        ...
        lat: -0.5897,
        lng: 101.3431,
        description: "Pulau terbesar keenam di dunia, rumah bagi harimau Sumatera, orangutan, dan Danau Toba yang legendaris. Menawarkan petualangan hutan hujan tropis yang liar.",
        stats: {
            rating: 4.7,
            visitors: "2M+",
            temperature: "28°C",
        },
        images: ["/assets/islands/sumatra.png"],
        color: "#ff5533",
    },
    {
        id: "java",
        ...
        lat: -7.6145,
        lng: 110.7122,
        description: "Pusat pemerintahan dan ekonomi Indonesia. Paduan sempurna metropolitan modern Jakarta, tradisi keraton Yogyakarta, dan keajaiban alam Gunung Bromo.",
        stats: {
            rating: 4.8,
            visitors: "15M+",
            temperature: "29°C",
        },
        images: ["/assets/islands/java.png"],
        color: "#33ff55",
    },
    {
        id: "kalimantan",
        ...
        lat: -0.9618,
        lng: 114.5684,
        description: "Paru-paru dunia dengan hutan hujan tertua. Temukan orangutan di habitat aslinya, susuri sungai Mahakam, dan rasakan budaya Dayak yang autentik.",
        stats: {
            rating: 4.6,
            visitors: "1M+",
            temperature: "30°C",
        },
        images: ["/assets/islands/kalimantan.png"],
        color: "#3355ff",
    },
    {
        id: "sulawesi",
        ...
        lat: -1.4300,
        lng: 121.4456,
        description: "Pulau berbentuk huruf K dengan garis pantai spektakuler. Surga penyelam di Bunaken dan Wakatobi, serta budaya unik Tana Toraja di dataran tinggi.",
        stats: {
            rating: 4.9,
            visitors: "500K+",
            temperature: "29°C",
        },
        images: ["/assets/islands/sulawesi.png"],
        color: "#ff33aa",
    },
    {
        id: "papua",
        ...
        lat: -4.2699,
        lng: 138.0804,
        description: "Ujung timur Indonesia dengan keanekaragaman hayati dan budaya yang luar biasa. Rumah bagi Raja Ampat dan Puncak Jaya yang bersalju abadi.",
        stats: {
            rating: 4.9,
            visitors: "100K+",
            temperature: "27°C",
        },
        images: ["/assets/islands/papua.png"],
        color: "#ffff33",
    },
];
